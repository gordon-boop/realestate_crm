...
export const frontendStatusConfig: FrontendStatusConfigDto[] = [
  ...
  { status: "OFFER_ACCEPTED", label: "UVA angenommen", color: "#5B8C2B" },
  { status: "EXPERT_OPINION_ORDERED", label: "Gutachten beauftragt", color: "#5C1077" },
  { status: "EXPERT_OPINION_RECEIVED", label: "Gutachten eingegangen", color: "#7B61C7" },
  { status: "BINDING_OFFER_SENT", label: "VA abgegeben", color: "#5B8C2B" },
  { status: "BINDING_OFFER_ACCEPTED", label: "VA angenommen", color: "#5B8C2B" },
  { status: "PURCHASE_STARTED", label: "Ankauf gestartet", color: "#5C1077" },
  { status: "NOTARY_APPOINTMENT", label: "Notartermin beauftragt", color: "#A8A443" },
  { status: "PURCHASED", label: "Kaufvertrag abgeschlossen", color: "#3D6B1F" },
